...
def tws_cal(data,lmax,gs,r,m,path_functions):
    ...
    # gs = 1
    # r=500
    # data = np.load('/home/wslvivek/Desktop/level2/Spyder/SC_numpy.npy')
    SC = data
    ...
    ''' save data as numpy & .mat'''
    #np.save('/home/wslvivek/Desktop/Jnb/tws_python/tws_py',tws)
    # import scipy.io
    # ff_dict = {"tws_py": (tws)}
    # scipy.io.savemat('tws_py.mat', ff_dict)
