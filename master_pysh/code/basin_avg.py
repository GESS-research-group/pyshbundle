...
def basin_avg(data,path,c_rs,m,gs):
    ...
    # data = xr.open_dataset('/home/wslvivek/Desktop/level2/master/output/tws_mat2py.nc')
    # m = data.tws.shape[0]
    # path = r"/home/wslvivek/Desktop/garca/vivek/Ganga.shp"
    ...
    return alpha
    #plt.savefig('Ganga.png', format = 'png', dpi = 300)